...
public class FileViewerAdapter extends RecyclerView.Adapter<FileViewerAdapter.RecordingsViewHolder>
    ...
    public FileViewerAdapter(Context context, LinearLayoutManager linearLayoutManager, FolderListener listener) {
        super();
        mContext = context;
    ...
    public void onBindViewHolder(final RecordingsViewHolder holder, int position) {
        ...
        if (date.isEmpty()) {
            holder.vName.setText(item.getFolder());
            holder.vLength.setVisibility(View.GONE);
            holder.vDateAdded.setVisibility(View.GONE);
            holder.cbFolder.setVisibility(View.VISIBLE);
            if (checkedFolders.contains(item.getFolder())) {
            ...
            holder.vLength.setVisibility(View.VISIBLE);
            holder.vDateAdded.setVisibility(View.VISIBLE);
            holder.cbFolder.setVisibility(View.GONE);
        }
        holder.cbFolder.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    checkedFolders.add(getItem(holder.getPosition()).getFolder());
                } else {
                    checkedFolders.remove(getItem(holder.getPosition()).getFolder());
                }
                listener.folderChecked(!checkedFolders.isEmpty());
            }
        });
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (date.isEmpty()) {
                    date = getItem(holder.getPosition()).getFolder();
                    listener.folderSelected(date);
    ...
    public void unSelectAllFolders() {
        checkedFolders.clear();
    }
    ...
    public static class RecordingsViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecordingsViewHolder(View v) {
            ...
            cbFolder = (CheckBox) v.findViewById(R.id.cbFolder);
        }
    }

    @Override
    public int getItemCount() {
        int count = mDatabase.getCount(date);
        return count;
    }

    public RecordingItem getItem(int position) {
        return mDatabase.getItemAt(position, date);
    }
    ...
    @Override
    public void onDatabaseEntryRemoved() {
        checkedFolders.clear();
        notifyDataSetChanged();
    }
